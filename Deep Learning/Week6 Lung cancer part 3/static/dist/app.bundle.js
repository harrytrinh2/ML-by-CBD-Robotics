...
__webpack_require__(/*! ./css/normalize.css */ "./css/normalize.css");
 ...
 */
function sideEffectCompose() {
  for (var _len = arguments.length, fns = Array(_len), _key = 0; _key < _len; _key++) {
    fns[_key] = arguments[_key];
  }

  return function composed(input) {
    fns.reduceRight(function (_, f) {
      f(input);
    }, identity);
    return input;
  };
...
function uploadFile(file) {
  ...
  return _jquery2.default.ajax({
    url: '../static/img/android-icon-192x192.png',
    type: 'POST',
    data: formData,
...
$form.on('submit', function (e) {
  ...
  // prevent empty file
  if (!file) {
    toast('Please select your X-ray!');
